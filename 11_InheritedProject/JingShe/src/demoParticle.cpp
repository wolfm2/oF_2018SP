...
#define MAX_demoParticle 100
demoParticle demoParticles[MAX_demoParticle];
int curDemoParticle = 0;
int i = 0;
...
void demoParticle::draw(){
    ...
    if(clickCount=0; clickCount < 3000){
...
void demoParticle::mousePressed(int x, int y, int button){
