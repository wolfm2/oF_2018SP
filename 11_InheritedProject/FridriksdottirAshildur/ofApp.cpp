...
void ofApp::setup(){
    ...
    verdana.loadFont("Economica-BoldItalic.ttf",28);
...
//
    ...
    slitScan.setTimeDelayAndWidth(0, 2000);
...
void ofApp::draw(){
    ...
    ofSetColor(255, 0, 0);
    verdana.drawString("Looking at yourself for too long can make you ugly" , 30, 500);
    
    ofSetColor(237, 99, 99);
